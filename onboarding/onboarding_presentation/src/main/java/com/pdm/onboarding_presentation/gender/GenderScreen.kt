package com.pdm.onboarding_presentation.gender
...
fun GenderScreen(
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = stringResource(id = com.pdm.core.R.string.whats_your_gender),
                style = MaterialTheme.typography.h3
            )
            Spacer(modifier = Modifier.height(spacing.spaceMedium))
            Row {
                SelectableButton(
                    text = stringResource(id = com.pdm.core.R.string.male),
                ...
                SelectableButton(
                    text = stringResource(id = com.pdm.core.R.string.female),
